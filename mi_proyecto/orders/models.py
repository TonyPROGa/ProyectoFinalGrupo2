...
class Order(models.Model):
	...
	def __str__(self):
		if self.complete == False:
			return f"Usuario: {self.user_id}, N° de Orden: {self.order_number}, Precio Total: ${self.precio_total}, Status: On Order"
		else:
			return f"Usuario: {self.user_id}, N° de Orden: {self.order_number}, Precio Total: ${self.precio_total}, Status: Complete"
